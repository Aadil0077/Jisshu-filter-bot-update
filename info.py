...
BOT_TOKEN = environ.get("BOT_TOKEN", "6554371802:AAGBjiJLjlkqvh9T7_u6-KtfDA7baGngJYM")
PORT = environ.get("PORT", "7023")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "851199369").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Movie Hub"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "Heisenberhgg")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002131762945").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1001999281293"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1001999281293"))
...
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://MovieHub:MovieHub@moviehub.wc2kpzb.mongodb.net/?retryWrites=true&w=majority")
...
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/M_HRequest")
